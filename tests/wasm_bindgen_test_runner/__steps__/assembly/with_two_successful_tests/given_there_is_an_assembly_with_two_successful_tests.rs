...
lazy_static! {
    static ref ASSEMBLY: PathBuf = AssemblyBuilder::new("assembly_with_two_successful_tests")
        .file(
            "src/lib.rs",
            r#"#[cfg(test)]
...
pub fn given_there_is_an_assembly_with_two_successful_tests(context: &mut Context) {
