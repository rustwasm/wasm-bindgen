...
#[test]
fn outputs_the_failed_test_execution_feature() {
    ...
    then_the_standard_output_should_have(context, "test assembly_with_one_successful_and_one_failing_test::fail ... FAIL");
}
