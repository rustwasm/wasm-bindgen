use crate::__steps__::assembly::given_there_is_an_assembly_with_one_successful_level_2_test;
...
feature! {
    given_there_is_an_assembly_with_one_successful_level_2_test();
    ...
    "Outputs the successful test summary" {
      then_the_standard_output_should_have("test assembly_with_one_successful_level_2_test::level_1::level_2::pass ... ok");
    }
