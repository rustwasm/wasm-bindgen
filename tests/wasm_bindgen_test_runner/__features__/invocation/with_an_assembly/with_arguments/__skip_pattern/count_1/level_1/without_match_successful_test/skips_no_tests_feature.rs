...
feature! {
    ...
    when_wasm_bindgen_test_runner_is_invoked_with_the_assembly_for_test_mode_and_the_arguments(test_mode, "--skip pattern");

    "Outputs the successful test information" {
        then_the_standard_output_should_have("test assembly_with_one_successful_level_1_test::level_1::pass ... ok");
    }
