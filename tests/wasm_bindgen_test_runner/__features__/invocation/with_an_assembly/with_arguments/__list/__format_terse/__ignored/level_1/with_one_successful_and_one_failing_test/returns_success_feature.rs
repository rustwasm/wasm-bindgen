use crate::__steps__::assembly::given_there_is_an_assembly_with_one_successful_and_one_failing_level_1_tests;
...
fn returns_success_feature() {
    ...
    given_there_is_an_assembly_with_one_successful_and_one_failing_level_1_tests(&mut context);
