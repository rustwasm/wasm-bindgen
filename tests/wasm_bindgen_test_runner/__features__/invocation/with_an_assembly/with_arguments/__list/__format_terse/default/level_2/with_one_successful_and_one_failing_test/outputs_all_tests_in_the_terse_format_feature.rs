use crate::__steps__::assembly::given_there_is_an_assembly_with_one_successful_and_one_failing_level_2_tests;
...
fn outputs_all_tests_in_the_terse_format_feature() {
    ...
    given_there_is_an_assembly_with_one_successful_and_one_failing_level_2_tests(&mut context);
