use crate::__steps__::assembly::given_there_is_an_assembly_with_one_ignored_level_2_test;
...
fn returns_success_feature() {
    ...
    given_there_is_an_assembly_with_one_ignored_level_2_test(&mut context);
