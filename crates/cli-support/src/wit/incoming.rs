...
impl InstructionBuilder<'_, '_> {
    ...
    fn incoming_option(&mut self, arg: &Descriptor) -> Result<(), Error> {
        match arg {
            ...
            Descriptor::I32 => self.in_option_sentinel64_int(AdapterType::I32),
            Descriptor::U32 => self.in_option_sentinel64_int(AdapterType::U32),
    ...
    fn in_option_sentinel64_int(&mut self, ty: AdapterType) {
        self.instruction(
            &[ty.option()],
