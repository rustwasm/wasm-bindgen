...
use crate::wit::{AuxExportFnAttrs, InstructionData};
...
impl<'a, 'b> Builder<'a, 'b> {
    ...
    pub fn process(
        ...
        generate_jsdoc: bool,
        debug_name: &str,
        export_fn_attrs: &Option<AuxExportFnAttrs>,
    ...
    fn typescript_signature(
        ...
        let ret_ty_override = export_fn_attrs.as_ref().and_then(|v| v.ret.ty.as_ref());
        let mut ts_ret = None;
    ...
    fn js_ts_doc_comments(
        ...
        let (ret_ty_override, ret_desc) = export_fn_attrs
            .as_ref()
            .map(|v| (v.ret.ty.as_ref(), v.ret.desc.as_ref()))
            .unwrap_or((None, None));
