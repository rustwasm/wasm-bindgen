...
#[cfg(feature = "num-traits")]
impl num_traits::CheckedAdd for BigInt {
    #[inline]
...
#[cfg(feature = "num-traits")]
impl num_traits::CheckedDiv for BigInt {
    #[inline]
...
#[cfg(feature = "num-traits")]
impl num_traits::CheckedMul for BigInt {
    #[inline]
...
#[cfg(feature = "num-traits")]
impl num_traits::CheckedSub for BigInt {
    #[inline]
...
pub enum ParseBigIntError {
    JsError(crate::Error),
    NumBigIntError(num_bigint::ParseBigIntError),
}
...
impl num_traits::Num for BigInt {
    ...
    fn from_str_radix(str: &str, radix: u32) -> Result<Self, Self::FromStrRadixErr> {
        if radix == 10 {
            match BigInt::from_str(str) {
                Ok(bigint) => Ok(bigint),
                Err(error) => Err(ParseBigIntError::JsError(error)),
            }
        } else {
            match num_bigint::BigInt::from_str_radix(str, radix) {
                Ok(num_bigint) => Ok(num_bigint.into()),
                Err(parse_err) => Err(ParseBigIntError::NumBigIntError(parse_err)),
            }
        }
    }
}
...
#[cfg(feature = "num-traits")]
impl num_traits::Pow<&BigInt> for &BigInt {
    type Output = BigInt;
...
#[cfg(feature = "num-traits")]
forward_deref_binop!(impl Pow, pow for BigInt);

#[cfg(feature = "num-traits")]
#[wasm_bindgen]
extern "C" {
    #[wasm_bindgen(method, js_name = "valueOf")]
    fn unchecked_as_i64(this: &BigInt) -> i64;

    #[wasm_bindgen(method, js_name = "valueOf")]
    fn unchecked_as_u64(this: &BigInt) -> u64;
}

#[cfg(all(feature = "num-bigint", feature = "num-traits"))]
impl num_traits::Signed for BigInt {
    fn abs(&self) -> Self {
        if self < &num_traits::Zero::zero() {
            -self
        } else {
            --self
        }
...
impl num_traits::ToPrimitive for BigInt {
    fn to_i64(&self) -> Option<i64> {
        let self_truncated = BigInt::as_int_n(64.0, self);
        if self == &self_truncated {
            Some(self.unchecked_as_i64())
        } else {
            None
        }
    }
    ...
    fn to_u64(&self) -> Option<u64> {
        let self_truncated = BigInt::as_uint_n(64.0, self);
        if self == &self_truncated {
            Some(self.unchecked_as_u64())
        } else {
            None
        }
    }
...
#[cfg(feature = "num-traits")]
impl num_traits::Bounded for Number {
    fn min_value() -> Self {
        Self::MIN_VALUE.into()
    }
...
impl num_traits::Inv for &Number {
    ...
    fn inv(self) -> Self::Output {
        f64::from(self).inv().into()
    }
}

#[cfg(feature = "num-traits")]
forward_deref_unop!(impl Inv, inv for Number);
...
#[cfg(feature = "num-traits")]
impl num_traits::Pow<&Number> for &Number {
    type Output = Number;
...
#[cfg(feature = "num-traits")]
forward_deref_binop!(impl Pow, pow for Number);

#[cfg(feature = "num-traits")]
impl num_traits::Signed for Number {
    fn abs(&self) -> Self {
        Math::abs(self.into()).into()
    }
    ...
    fn signum(&self) -> Self {
        f64::from(self).signum().into()
    }

    fn is_positive(&self) -> bool {
        f64::from(self).is_sign_positive()
    }

    fn is_negative(&self) -> bool {
        f64::from(self).is_sign_negative()
    }
}
...
impl num_traits::ToPrimitive for Number {
    ...
    fn to_u16(&self) -> Option<u16> {
        f64::from(self).to_u16()
    }

    fn to_u32(&self) -> Option<u32> {
        f64::from(self).to_u32()
    }
...
impl num_traits::Zero for Number {
    ...
    #[inline]
    fn is_zero(&self) -> bool {
        self == &<Number as num_traits::Zero>::zero()
    }
}
