...
extern "C" {
    ...
    fn set_label(this: &GpuRenderPipelineDescriptor, val: &str);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_layout(this: &GpuRenderPipelineDescriptor, val: &::wasm_bindgen::JsValue);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_stencil(this: &GpuRenderPipelineDescriptor, val: &GpuDepthStencilState);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_fragment(this: &GpuRenderPipelineDescriptor, val: &GpuFragmentState);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_multisample(this: &GpuRenderPipelineDescriptor, val: &GpuMultisampleState);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_primitive(this: &GpuRenderPipelineDescriptor, val: &GpuPrimitiveState);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_vertex(this: &GpuRenderPipelineDescriptor, val: &GpuVertexState);
}
#[cfg(web_sys_unstable_apis)]
