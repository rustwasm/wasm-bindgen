...
extern "C" {
    ...
    pub fn set_title(this: &HtmlElement, value: String);
    ...
    pub fn set_lang(this: &HtmlElement, value: String);
    ...
    pub fn set_dir(this: &HtmlElement, value: String);
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = innerText ) ]
    ...
    pub fn set_inner_text(this: &HtmlElement, value: String);
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = hidden ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = accessKey ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = accessKey ) ]
    #[doc = "Setter for the `accessKey` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/accessKey)\n\n*This API requires the following crate features to be activated: `HtmlElement`*"]
    pub fn set_access_key(this: &HtmlElement, value: String);
    # [ wasm_bindgen ( structural , method , getter , js_name = accessKeyLabel ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = draggable ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = draggable ) ]
    #[doc = "Setter for the `draggable` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/draggable)\n\n*This API requires the following crate features to be activated: `HtmlElement`*"]
    pub fn set_draggable(this: &HtmlElement, value: bool);
    # [ wasm_bindgen ( structural , method , getter , js_name = contentEditable ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = contentEditable ) ]
    #[doc = "Setter for the `contentEditable` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/contentEditable)\n\n*This API requires the following crate features to be activated: `HtmlElement`*"]
    pub fn set_content_editable(this: &HtmlElement, value: String);
    # [ wasm_bindgen ( structural , method , getter , js_name = isContentEditable ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = spellcheck ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = spellcheck ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = offsetParent ) ]
    #[cfg(feature = "Element")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = offsetTop ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = offsetLeft ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = offsetWidth ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = offsetHeight ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = click ) ]
