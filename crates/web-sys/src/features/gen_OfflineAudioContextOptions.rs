...
extern "C" {
    ...
    fn set_length(this: &OfflineAudioContextOptions, val: u32);
    ...
    fn set_number_of_channels(this: &OfflineAudioContextOptions, val: u32);
    ...
    fn set_sample_rate(this: &OfflineAudioContextOptions, val: f32);
}
