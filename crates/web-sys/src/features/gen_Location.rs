...
extern "C" {
    ...
    pub fn set_href(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_protocol(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_host(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_hostname(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_port(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_pathname(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_search(this: &Location, value: Result<String, JsValue>);
    ...
    pub fn set_hash(this: &Location, value: Result<String, JsValue>);
