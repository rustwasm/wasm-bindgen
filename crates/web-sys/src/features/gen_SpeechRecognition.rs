...
extern "C" {
    ...
    pub fn set_lang(this: &SpeechRecognition, value: String);
    ...
    pub fn set_continuous(this: &SpeechRecognition, value: Result<bool, JsValue>);
    ...
    pub fn set_service_uri(this: &SpeechRecognition, value: Result<String, JsValue>);
