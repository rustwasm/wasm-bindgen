...
extern "C" {
    ...
    fn set_audio_bits_per_second(this: &MediaRecorderOptions, val: u32);
    ...
    fn set_bits_per_second(this: &MediaRecorderOptions, val: u32);
    ...
    fn set_mime_type(this: &MediaRecorderOptions, val: &str);
    ...
    fn set_video_bits_per_second(this: &MediaRecorderOptions, val: u32);
}
