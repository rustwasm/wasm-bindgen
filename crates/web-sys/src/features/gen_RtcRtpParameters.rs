...
extern "C" {
    ...
    fn set_codecs(this: &RtcRtpParameters, val: &::wasm_bindgen::JsValue);
    ...
    fn set_encodings(this: &RtcRtpParameters, val: &::wasm_bindgen::JsValue);
    ...
    fn set_header_extensions(this: &RtcRtpParameters, val: &::wasm_bindgen::JsValue);
    ...
    fn set_rtcp(this: &RtcRtpParameters, val: &RtcRtcpParameters);
}
