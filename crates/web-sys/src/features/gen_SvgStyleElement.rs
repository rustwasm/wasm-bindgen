...
extern "C" {
    ...
    pub fn set_xmlspace(this: &SvgStyleElement, value: String);
    ...
    pub fn set_type(this: &SvgStyleElement, value: String);
    ...
    pub fn set_media(this: &SvgStyleElement, value: String);
    ...
    pub fn set_title(this: &SvgStyleElement, value: String);
