...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = latitude ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = longitude ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = altitude ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = accuracy ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = altitudeAccuracy ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = heading ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = speed ) ]
