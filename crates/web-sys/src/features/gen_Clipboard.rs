...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `Clipboard`*"]
    #[doc = ""]
    #[doc = "Argument `data`: While the iterable or array can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>&[ClipboardItem]</code>."]
    #[doc = ""]
