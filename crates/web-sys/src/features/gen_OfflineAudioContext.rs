...
extern "C" {
    ...
    #[cfg(all(feature = "Float32Array", feature = "PeriodicWave",))]
    # [wasm_bindgen (catch , method , structural , js_class = "OfflineAudioContext" , js_name = createPeriodicWave)]
    #[doc = "The `createPeriodicWave()` method."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/OfflineAudioContext/createPeriodicWave)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Float32Array`, `OfflineAudioContext`, `PeriodicWave`*"]
    ...
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/OfflineAudioContext/createPeriodicWave)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Float32Array`, `OfflineAudioContext`, `PeriodicWave`, `PeriodicWaveConstraints`*"]
