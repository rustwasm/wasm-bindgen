...
extern "C" {
    ...
    #[cfg(feature = "VrEye")]
    # [ wasm_bindgen ( method , structural , js_name = setEyeParameter ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setEyeResolution ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setMountState ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setPose ) ]
