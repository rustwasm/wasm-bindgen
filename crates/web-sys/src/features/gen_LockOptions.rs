...
extern "C" {
    ...
    fn set_if_available(this: &LockOptions, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_mode(this: &LockOptions, val: LockMode);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_signal(this: &LockOptions, val: &AbortSignal);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_steal(this: &LockOptions, val: bool);
}
#[cfg(web_sys_unstable_apis)]
impl LockOptions {
