...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = caption ) ]
    ...
    #[cfg(feature = "HtmlElement")]
    # [ wasm_bindgen ( method , structural , js_name = createTBody ) ]
    ...
    #[cfg(feature = "HtmlElement")]
    # [ wasm_bindgen ( method , structural , js_name = createTFoot ) ]
    ...
    #[cfg(feature = "HtmlElement")]
    # [ wasm_bindgen ( method , structural , js_name = createTHead ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = deleteCaption ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = deleteTFoot ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = deleteTHead ) ]
