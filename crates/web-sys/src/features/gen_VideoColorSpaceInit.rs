...
extern "C" {
    ...
    fn set_full_range(this: &VideoColorSpaceInit, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_matrix(this: &VideoColorSpaceInit, val: VideoMatrixCoefficients);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_primaries(this: &VideoColorSpaceInit, val: VideoColorPrimaries);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_transfer(this: &VideoColorSpaceInit, val: VideoTransferCharacteristics);
}
#[cfg(web_sys_unstable_apis)]
