...
extern "C" {
    ...
    # [wasm_bindgen (method , structural , js_class = "AuthenticatorAttestationResponse" , js_name = getAuthenticatorData)]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AuthenticatorAttestationResponse`*"]
    pub fn get_authenticator_data(this: &AuthenticatorAttestationResponse)
        -> ::js_sys::ArrayBuffer;
    # [wasm_bindgen (method , structural , js_class = "AuthenticatorAttestationResponse" , js_name = getPublicKey)]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AuthenticatorAttestationResponse`*"]
    pub fn get_public_key(this: &AuthenticatorAttestationResponse)
        -> Option<::js_sys::ArrayBuffer>;
    # [wasm_bindgen (method , structural , js_class = "AuthenticatorAttestationResponse" , js_name = getPublicKeyAlgorithm)]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AuthenticatorAttestationResponse`*"]
    pub fn get_public_key_algorithm(this: &AuthenticatorAttestationResponse) -> i32;
