...
extern "C" {
    ...
    fn id_shim(this: &RtcInboundRtpStreamStats) -> &str;
    ...
    fn codec_id_shim(this: &RtcInboundRtpStreamStats) -> &str;
    ...
    fn media_track_id_shim(this: &RtcInboundRtpStreamStats) -> &str;
    ...
    fn media_type_shim(this: &RtcInboundRtpStreamStats) -> &str;
    ...
    fn remote_id_shim(this: &RtcInboundRtpStreamStats) -> &str;
    ...
    fn ssrc_shim(this: &RtcInboundRtpStreamStats) -> &str;
    ...
    fn transport_id_shim(this: &RtcInboundRtpStreamStats) -> &str;
