...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getSubscription ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = permissionState ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = subscribe ) ]
