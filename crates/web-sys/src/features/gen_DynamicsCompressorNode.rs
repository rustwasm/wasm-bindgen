...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = threshold ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = knee ) ]
    #[cfg(feature = "AudioParam")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = ratio ) ]
    #[cfg(feature = "AudioParam")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = reduction ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = attack ) ]
    #[cfg(feature = "AudioParam")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = release ) ]
    #[cfg(feature = "AudioParam")]
