...
impl AuthenticatorSelectionCriteria {
    ///Construct a new `AuthenticatorSelectionCriteria`.
    ///
    ///*This API requires the following crate features to be activated: `AuthenticatorSelectionCriteria`*
    ...
    ///Change the `authenticatorAttachment` field of this object.
    ///
    ...
    ///Change the `requireResidentKey` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `AuthenticatorSelectionCriteria`*
    ...
    ///Change the `userVerification` field of this object.
    ///
