...
impl DnsCacheDict {
    ...
    #[doc = "*This API requires the following crate features to be activated: `DnsCacheDict`*"]
    #[doc = ""]
    #[doc = "While the iterable or array can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>&[DnsCacheEntry]</code>."]
