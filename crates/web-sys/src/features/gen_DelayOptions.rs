...
extern "C" {
    ...
    fn set_channel_count(this: &DelayOptions, val: u32);
    ...
    fn set_channel_count_mode(this: &DelayOptions, val: ChannelCountMode);
    ...
    fn set_channel_interpretation(this: &DelayOptions, val: ChannelInterpretation);
    ...
    fn set_delay_time(this: &DelayOptions, val: f64);
    ...
    fn set_max_delay_time(this: &DelayOptions, val: f64);
}
impl DelayOptions {
