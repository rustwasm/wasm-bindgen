...
extern "C" {
    ...
    fn beginning_of_pass_write_index_shim(this: &GpuComputePassTimestampWrites, val: u32);
    #[wasm_bindgen(method, setter = "endOfPassWriteIndex")]
    fn end_of_pass_write_index_shim(this: &GpuComputePassTimestampWrites, val: u32);
    #[cfg(feature = "GpuQuerySet")]
    #[wasm_bindgen(method, setter = "querySet")]
    fn query_set_shim(this: &GpuComputePassTimestampWrites, val: &GpuQuerySet);
}
#[cfg(web_sys_unstable_apis)]
