...
extern "C" {
    ...
    fn beginning_of_pass_write_index_shim(this: &GpuRenderPassTimestampWrites) -> u32;
    #[wasm_bindgen(method, setter = "beginningOfPassWriteIndex")]
    fn set_beginning_of_pass_write_index_shim(this: &GpuRenderPassTimestampWrites, val: u32);
    #[wasm_bindgen(method, getter = "endOfPassWriteIndex")]
    fn end_of_pass_write_index_shim(this: &GpuRenderPassTimestampWrites) -> u32;
    #[wasm_bindgen(method, setter = "endOfPassWriteIndex")]
    fn set_end_of_pass_write_index_shim(this: &GpuRenderPassTimestampWrites, val: u32);
    #[cfg(feature = "GpuQuerySet")]
    #[wasm_bindgen(method, getter = "querySet")]
    fn query_set_shim(this: &GpuRenderPassTimestampWrites) -> GpuQuerySet;
    #[cfg(feature = "GpuQuerySet")]
    #[wasm_bindgen(method, setter = "querySet")]
    fn set_query_set_shim(this: &GpuRenderPassTimestampWrites, val: &GpuQuerySet);
}
#[cfg(web_sys_unstable_apis)]
