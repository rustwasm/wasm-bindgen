...
extern "C" {
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = x)]
    #[doc = "Setter for the `x` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/x)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_x(this: &SvgPathSegArcAbs, value: f32) -> Result<(), JsValue>;
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = y)]
    #[doc = "Setter for the `y` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/y)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_y(this: &SvgPathSegArcAbs, value: f32) -> Result<(), JsValue>;
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = r1)]
    #[doc = "Setter for the `r1` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/r1)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_r1(this: &SvgPathSegArcAbs, value: f32) -> Result<(), JsValue>;
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = r2)]
    #[doc = "Setter for the `r2` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/r2)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_r2(this: &SvgPathSegArcAbs, value: f32) -> Result<(), JsValue>;
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = angle)]
    #[doc = "Setter for the `angle` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/angle)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_angle(this: &SvgPathSegArcAbs, value: f32) -> Result<(), JsValue>;
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = largeArcFlag)]
    #[doc = "Setter for the `largeArcFlag` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/largeArcFlag)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_large_arc_flag(this: &SvgPathSegArcAbs, value: bool) -> Result<(), JsValue>;
    ...
    # [wasm_bindgen (structural , catch , method , setter , js_class = "SVGPathSegArcAbs" , js_name = sweepFlag)]
    #[doc = "Setter for the `sweepFlag` field of this object."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathSegArcAbs/sweepFlag)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgPathSegArcAbs`*"]
    pub fn set_sweep_flag(this: &SvgPathSegArcAbs, value: bool) -> Result<(), JsValue>;
}
