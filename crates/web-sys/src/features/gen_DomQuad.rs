...
extern "C" {
    ...
    pub type DomQuad;
    # [ wasm_bindgen ( structural , method , getter , js_name = p1 ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = p2 ) ]
    #[cfg(feature = "DomPoint")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = p3 ) ]
    #[cfg(feature = "DomPoint")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = p4 ) ]
    #[cfg(feature = "DomPoint")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = bounds ) ]
    ...
    #[cfg(feature = "DomRectReadOnly")]
    # [ wasm_bindgen ( method , structural , js_name = getBounds ) ]
