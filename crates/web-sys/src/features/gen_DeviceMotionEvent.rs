...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = acceleration ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = accelerationIncludingGravity ) ]
    #[cfg(feature = "DeviceAcceleration")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rotationRate ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = interval ) ]
