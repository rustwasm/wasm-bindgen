...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = speaking ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = onvoiceschanged ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getVoices ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = pause ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = resume ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = speak ) ]
