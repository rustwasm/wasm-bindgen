...
extern "C" {
    ...
    fn set_bubbles(this: &DeviceLightEventInit, val: bool);
    ...
    fn set_cancelable(this: &DeviceLightEventInit, val: bool);
    ...
    fn set_composed(this: &DeviceLightEventInit, val: bool);
    ...
    fn set_value(this: &DeviceLightEventInit, val: f64);
}
