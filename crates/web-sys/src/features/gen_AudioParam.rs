...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = minValue ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = maxValue ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = cancelScheduledValues ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = exponentialRampToValueAtTime ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = linearRampToValueAtTime ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = setTargetAtTime ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = setValueAtTime ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = setValueCurveAtTime ) ]
