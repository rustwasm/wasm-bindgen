...
extern "C" {
    ...
    fn error_shim(this: &VideoDecoderInit) -> &::js_sys::Function;
    #[wasm_bindgen(method, setter = "error")]
    fn set_error_shim(this: &VideoDecoderInit, val: &::js_sys::Function);
    #[wasm_bindgen(method, getter = "output")]
    fn output_shim(this: &VideoDecoderInit) -> &::js_sys::Function;
    #[wasm_bindgen(method, setter = "output")]
    fn set_output_shim(this: &VideoDecoderInit, val: &::js_sys::Function);
}
#[cfg(web_sys_unstable_apis)]
