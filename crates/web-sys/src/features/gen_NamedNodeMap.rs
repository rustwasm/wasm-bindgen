...
extern "C" {
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( method , structural , js_name = getNamedItem ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( method , structural , js_name = getNamedItemNS ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , structural , js_name = removeNamedItem ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , structural , js_name = removeNamedItemNS ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , structural , js_name = setNamedItem ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , structural , js_name = setNamedItemNS ) ]
