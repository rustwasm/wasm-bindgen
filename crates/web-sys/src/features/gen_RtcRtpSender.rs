...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = dtmf ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getParameters ) ]
    ...
    #[cfg(feature = "MediaStreamTrack")]
    # [ wasm_bindgen ( method , structural , js_name = replaceTrack ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setParameters ) ]
