...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = mutableFile ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = location ) ]
    ...
    #[cfg(feature = "IdbFileRequest")]
    # [ wasm_bindgen ( catch , method , structural , js_name = flush ) ]
    ...
    #[cfg(feature = "IdbFileRequest")]
    # [ wasm_bindgen ( catch , method , structural , js_name = getMetadata ) ]
    ...
    #[cfg(feature = "IdbFileRequest")]
    # [ wasm_bindgen ( catch , method , structural , js_name = truncate ) ]
