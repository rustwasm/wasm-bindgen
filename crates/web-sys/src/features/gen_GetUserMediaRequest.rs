...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = windowID ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = innerWindowID ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = callID ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = mediaSource ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = isSecure ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = isHandlingUserInput ) ]
