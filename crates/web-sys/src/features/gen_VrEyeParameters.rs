...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = offset ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = fieldOfView ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = renderWidth ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = renderHeight ) ]
