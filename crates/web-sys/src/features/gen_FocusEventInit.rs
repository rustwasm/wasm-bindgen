...
extern "C" {
    ...
    fn set_bubbles(this: &FocusEventInit, val: bool);
    ...
    fn set_cancelable(this: &FocusEventInit, val: bool);
    ...
    fn set_composed(this: &FocusEventInit, val: bool);
    ...
    fn set_detail(this: &FocusEventInit, val: i32);
    #[cfg(feature = "Window")]
    ...
    fn set_view(this: &FocusEventInit, val: Option<&Window>);
    ...
    fn set_related_target(this: &FocusEventInit, val: Option<&EventTarget>);
}
impl FocusEventInit {
