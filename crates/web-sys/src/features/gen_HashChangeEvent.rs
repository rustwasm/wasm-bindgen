...
extern "C" {
    ...
    ///Getter for the `oldURL` field of this object.
    ///
    ...
    ///Getter for the `newURL` field of this object.
    ///
    ...
    ///The `new HashChangeEvent(..)` constructor, creating a new instance of `HashChangeEvent`.
    ///
    ...
    ///The `initHashChangeEvent()` method.
    ///
