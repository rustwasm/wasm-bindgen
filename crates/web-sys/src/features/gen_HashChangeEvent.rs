...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = oldURL ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = newURL ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = initHashChangeEvent ) ]
