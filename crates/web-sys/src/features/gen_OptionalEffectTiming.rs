...
extern "C" {
    ...
    fn delay_shim(this: &OptionalEffectTiming, val: f64);
    #[cfg(feature = "PlaybackDirection")]
    #[wasm_bindgen(method, setter = "direction")]
    fn direction_shim(this: &OptionalEffectTiming, val: PlaybackDirection);
    #[wasm_bindgen(method, setter = "duration")]
    fn duration_shim(this: &OptionalEffectTiming, val: &::wasm_bindgen::JsValue);
    #[wasm_bindgen(method, setter = "easing")]
    fn easing_shim(this: &OptionalEffectTiming, val: &str);
    #[wasm_bindgen(method, setter = "endDelay")]
    fn end_delay_shim(this: &OptionalEffectTiming, val: f64);
    #[cfg(feature = "FillMode")]
    #[wasm_bindgen(method, setter = "fill")]
    fn fill_shim(this: &OptionalEffectTiming, val: FillMode);
    #[wasm_bindgen(method, setter = "iterationStart")]
    fn iteration_start_shim(this: &OptionalEffectTiming, val: f64);
    #[wasm_bindgen(method, setter = "iterations")]
    fn iterations_shim(this: &OptionalEffectTiming, val: f64);
}
