...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = relatedNode ) ]
    #[cfg(feature = "Node")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = prevValue ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = attrName ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = attrChange ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = initMutationEvent ) ]
