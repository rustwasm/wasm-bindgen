...
extern "C" {
    ...
    fn set_bubbles(this: &InputEventInit, val: bool);
    ...
    fn set_cancelable(this: &InputEventInit, val: bool);
    ...
    fn set_composed(this: &InputEventInit, val: bool);
    ...
    fn set_detail(this: &InputEventInit, val: i32);
    #[cfg(feature = "Window")]
    ...
    fn set_view(this: &InputEventInit, val: Option<&Window>);
    ...
    fn set_data(this: &InputEventInit, val: Option<&str>);
    ...
    fn set_data_transfer(this: &InputEventInit, val: Option<&DataTransfer>);
    ...
    fn set_input_type(this: &InputEventInit, val: &str);
    ...
    fn set_is_composing(this: &InputEventInit, val: bool);
    ...
    fn set_target_ranges(this: &InputEventInit, val: &::wasm_bindgen::JsValue);
}
impl InputEventInit {
