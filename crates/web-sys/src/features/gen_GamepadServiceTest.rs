...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "Return value: While the Promise can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>[u32]</code>. It can be converted like `<code>let result: [u32] = result?.await.into();</code>."]
    pub fn add_gamepad(
