...
extern "C" {
    ...
    fn set_data(this: &EncodedAudioChunkInit, val: &::js_sys::Object);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_duration(this: &EncodedAudioChunkInit, val: f64);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_timestamp(this: &EncodedAudioChunkInit, val: f64);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_type(this: &EncodedAudioChunkInit, val: EncodedAudioChunkType);
}
#[cfg(web_sys_unstable_apis)]
