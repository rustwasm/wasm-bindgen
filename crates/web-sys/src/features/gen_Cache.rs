...
extern "C" {
    ...
    pub type Cache;
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( method , structural , js_name = add ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = addAll ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = keys ) ]
    ...
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( method , structural , js_name = match ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = put ) ]
