...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = targetElement ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = beginElement ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = beginElementAt ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = endElement ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = endElementAt ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getSimpleDuration ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getStartTime ) ]
