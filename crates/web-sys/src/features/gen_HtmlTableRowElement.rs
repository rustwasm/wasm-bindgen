...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rowIndex ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = sectionRowIndex ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = cells ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = insertCell ) ]
