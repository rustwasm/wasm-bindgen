...
extern "C" {
    ...
    pub fn set_name(this: &HtmlParamElement, value: String);
    ...
    pub fn set_value(this: &HtmlParamElement, value: String);
    ...
    pub fn set_type(this: &HtmlParamElement, value: String);
    ...
    pub fn set_value_type(this: &HtmlParamElement, value: String);
}
