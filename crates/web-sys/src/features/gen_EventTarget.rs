...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = addEventListener ) ]
    ...
    #[cfg(feature = "Event")]
    # [ wasm_bindgen ( catch , method , structural , js_name = dispatchEvent ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = removeEventListener ) ]
