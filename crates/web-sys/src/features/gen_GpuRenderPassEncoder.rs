...
extern "C" {
    ...
    #[wasm_bindgen(
        ...
        structural,
        js_class = "GPURenderPassEncoder",
        js_name = "beginPipelineStatisticsQuery"
    )]
    ...
    #[wasm_bindgen(
        ...
        structural,
        js_class = "GPURenderPassEncoder",
        js_name = "endPipelineStatisticsQuery"
    )]
