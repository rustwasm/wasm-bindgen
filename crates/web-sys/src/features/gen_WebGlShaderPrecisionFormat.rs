...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rangeMin ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rangeMax ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = precision ) ]
