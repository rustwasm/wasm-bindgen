...
extern "C" {
    ...
    #[doc = "The `GpuBindGroupDescriptor` dictionary.\n\n*This API requires the following crate features to be activated: `GpuBindGroupDescriptor`, `GpuBindGroupLayout`*"]
...
impl GpuBindGroupDescriptor {
    ...
    #[doc = "Change the `label` field of this object.\n\n*This API requires the following crate features to be activated: `GpuBindGroupDescriptor`*"]
