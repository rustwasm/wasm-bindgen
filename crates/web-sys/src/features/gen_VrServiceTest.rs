...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `VrServiceTest`*"]
    #[doc = ""]
    #[doc = "Return value: While the Promise of the successful result can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>[VrMockController]</code>. It can be converted like `<code>let result: [VrMockController] = result?.await.into();</code>."]
    ...
    #[doc = "*This API requires the following crate features to be activated: `VrServiceTest`*"]
    #[doc = ""]
    #[doc = "Return value: While the Promise of the successful result can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>[VrMockDisplay]</code>. It can be converted like `<code>let result: [VrMockDisplay] = result?.await.into();</code>."]
