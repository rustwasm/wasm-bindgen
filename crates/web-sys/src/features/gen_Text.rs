...
#[wasm_bindgen]
extern "C" {
    # [ wasm_bindgen ( extends = CharacterData , extends = Node , extends = EventTarget , extends = :: js_sys :: Object , js_name = Text , typescript_name = Text ) ]
    ...
    pub type Text;
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = wholeText ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = splitText ) ]
