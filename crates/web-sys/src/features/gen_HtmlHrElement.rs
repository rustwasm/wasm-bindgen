...
extern "C" {
    ...
    pub fn set_align(this: &HtmlHrElement, value: String);
    ...
    pub fn set_color(this: &HtmlHrElement, value: String);
    ...
    pub fn set_size(this: &HtmlHrElement, value: String);
    ...
    pub fn set_width(this: &HtmlHrElement, value: String);
}
