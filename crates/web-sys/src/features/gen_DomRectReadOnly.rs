...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = top ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = right ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = bottom ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = left ) ]
