...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = focused ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = focused ) ]
    #[doc = "Setter for the `focused` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/TreeBoxObject/focused)\n\n*This API requires the following crate features to be activated: `TreeBoxObject`*"]
    pub fn set_focused(this: &TreeBoxObject, value: bool);
    # [ wasm_bindgen ( structural , method , getter , js_name = treeBody ) ]
    #[cfg(feature = "Element")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rowHeight ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rowWidth ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = horizontalPosition ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = beginUpdateBatch ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = clearStyleAndImageCaches ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = endUpdateBatch ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = ensureRowIsVisible ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getCellAt ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getFirstVisibleRow ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getLastVisibleRow ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getPageLength ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getRowAt ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = invalidate ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = invalidateRange ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = invalidateRow ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = rowCountChanged ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = scrollByPages ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = scrollToRow ) ]
