...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = stdDeviationX ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = stdDeviationY ) ]
    #[cfg(feature = "SvgAnimatedNumber")]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setStdDeviation ) ]
