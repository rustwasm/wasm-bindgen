...
extern "C" {
    ...
    fn origin_time_shim(this: &DocumentTimelineOptions) -> f64;
    #[wasm_bindgen(method, setter = "originTime")]
    fn set_origin_time_shim(this: &DocumentTimelineOptions, val: f64);
}
