...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = iterationComposite ) ]
    #[cfg(feature = "IterationCompositeOperation")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = composite ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = composite ) ]
    #[cfg(feature = "CompositeOperation")]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getKeyframes ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = setKeyframes ) ]
