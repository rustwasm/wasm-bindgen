...
extern "C" {
    ...
    fn x_shim(this: &GpuOrigin3dDict) -> u32;
    #[wasm_bindgen(method, setter = "x")]
    fn set_x_shim(this: &GpuOrigin3dDict, val: u32);
    #[wasm_bindgen(method, getter = "y")]
    fn y_shim(this: &GpuOrigin3dDict) -> u32;
    #[wasm_bindgen(method, setter = "y")]
    fn set_y_shim(this: &GpuOrigin3dDict, val: u32);
    #[wasm_bindgen(method, getter = "z")]
    fn z_shim(this: &GpuOrigin3dDict) -> u32;
    #[wasm_bindgen(method, setter = "z")]
    fn set_z_shim(this: &GpuOrigin3dDict, val: u32);
}
#[cfg(web_sys_unstable_apis)]
