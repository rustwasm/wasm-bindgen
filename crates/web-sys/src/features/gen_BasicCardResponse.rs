...
extern "C" {
    ...
    fn card_number_shim(this: &BasicCardResponse) -> &str;
    ...
    fn card_security_code_shim(this: &BasicCardResponse) -> &str;
    ...
    fn cardholder_name_shim(this: &BasicCardResponse) -> &str;
    ...
    fn expiry_month_shim(this: &BasicCardResponse) -> &str;
    ...
    fn expiry_year_shim(this: &BasicCardResponse) -> &str;
