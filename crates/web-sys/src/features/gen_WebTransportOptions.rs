...
extern "C" {
    ...
    fn set_allow_pooling(this: &WebTransportOptions, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_congestion_control(this: &WebTransportOptions, val: WebTransportCongestionControl);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_require_unreliable(this: &WebTransportOptions, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_server_certificate_hashes(this: &WebTransportOptions, val: &::wasm_bindgen::JsValue);
}
#[cfg(web_sys_unstable_apis)]
