...
#[wasm_bindgen]
extern "C" {
    # [ wasm_bindgen ( extends = SvgAnimationElement , extends = SvgElement , extends = Element , extends = Node , extends = EventTarget , extends = :: js_sys :: Object , js_name = SVGAnimateElement , typescript_name = SVGAnimateElement ) ]
