...
extern "C" {
    ...
    # [ wasm_bindgen ( method , structural , js_name = beginComputePass ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = beginRenderPass ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = copyBufferToBuffer ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = copyBufferToTexture ) ]
    ...
    #[cfg(all(feature = "GpuBufferCopyView", feature = "GpuTextureCopyView",))]
    # [ wasm_bindgen ( method , structural , js_name = copyTextureToBuffer ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = copyTextureToTexture ) ]
