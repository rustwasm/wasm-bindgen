...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = reversed ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = reversed ) ]
    #[doc = "Setter for the `reversed` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLOListElement/reversed)\n\n*This API requires the following crate features to be activated: `HtmlOListElement`*"]
    pub fn set_reversed(this: &HtmlOListElement, value: bool);
    # [ wasm_bindgen ( structural , method , getter , js_name = start ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = start ) ]
