...
extern "C" {
    ...
    fn set_exclude_accept_all_option(this: &FilePickerOptions, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_id(this: &FilePickerOptions) -> Option<String>;
    #[wasm_bindgen(method, setter = "id")]
    fn set_id(this: &FilePickerOptions, val: &str);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_start_in(this: &FilePickerOptions, val: &::wasm_bindgen::JsValue);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_types(this: &FilePickerOptions, val: &::wasm_bindgen::JsValue);
}
#[cfg(web_sys_unstable_apis)]
