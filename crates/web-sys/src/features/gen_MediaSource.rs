...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = sourceBuffers ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = activeSourceBuffers ) ]
    #[cfg(feature = "SourceBufferList")]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = duration ) ]
    #[doc = "Setter for the `duration` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/MediaSource/duration)\n\n*This API requires the following crate features to be activated: `MediaSource`*"]
    pub fn set_duration(this: &MediaSource, value: f64);
    # [ wasm_bindgen ( structural , method , getter , js_name = onsourceopen ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = addSourceBuffer ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = clearLiveSeekableRange ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = endOfStream ) ]
    ...
    # [ wasm_bindgen ( method , structural , static_method_of = MediaSource , js_name = isTypeSupported ) ]
    ...
    #[cfg(feature = "SourceBuffer")]
    # [ wasm_bindgen ( catch , method , structural , js_name = removeSourceBuffer ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = setLiveSeekableRange ) ]
