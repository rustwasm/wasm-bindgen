...
extern "C" {
    ...
    fn set_cache_not_slow_count(this: &RcwnStatus, val: u32);
    ...
    fn set_cache_slow_count(this: &RcwnStatus, val: u32);
    ...
    fn set_perf_stats(this: &RcwnStatus, val: &::wasm_bindgen::JsValue);
    ...
    fn set_rcwn_cache_won_count(this: &RcwnStatus, val: u32);
    ...
    fn set_rcwn_net_won_count(this: &RcwnStatus, val: u32);
    ...
    fn set_total_network_requests(this: &RcwnStatus, val: u32);
}
impl RcwnStatus {
