...
extern "C" {
    ...
    fn set_index(this: &UsbControlTransferParameters, val: u16);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_recipient(this: &UsbControlTransferParameters, val: UsbRecipient);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_request(this: &UsbControlTransferParameters, val: u8);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_request_type(this: &UsbControlTransferParameters, val: UsbRequestType);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_value(this: &UsbControlTransferParameters, val: u16);
}
#[cfg(web_sys_unstable_apis)]
