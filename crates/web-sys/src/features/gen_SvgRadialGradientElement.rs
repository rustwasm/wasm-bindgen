...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = cx ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = cy ) ]
    #[cfg(feature = "SvgAnimatedLength")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = r ) ]
    #[cfg(feature = "SvgAnimatedLength")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = fx ) ]
    #[cfg(feature = "SvgAnimatedLength")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = fy ) ]
    #[cfg(feature = "SvgAnimatedLength")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = fr ) ]
    #[cfg(feature = "SvgAnimatedLength")]
