...
extern "C" {
    ...
    pub type Touch;
    # [ wasm_bindgen ( structural , method , getter , js_name = identifier ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = rotationAngle ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = force ) ]
