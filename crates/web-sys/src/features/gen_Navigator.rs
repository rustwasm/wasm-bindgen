...
extern "C" {
    ...
    pub type Navigator;
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = permissions ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = mimeTypes ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = plugins ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = doNotTrack ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = maxTouchPoints ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = activeVRDisplays ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = mediaDevices ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = serviceWorker ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = presentation ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = geolocation ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getGamepads ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getVRDisplays ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = requestGamepadServiceTest ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = requestMIDIAccess ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = requestMediaKeySystemAccess ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = requestVRServiceTest ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = sendBeacon ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = vibrate ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = registerContentHandler ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = registerProtocolHandler ) ]
