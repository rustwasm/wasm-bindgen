...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = colSpan ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = colSpan ) ]
    #[doc = "Setter for the `colSpan` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableCellElement/colSpan)\n\n*This API requires the following crate features to be activated: `HtmlTableCellElement`*"]
    pub fn set_col_span(this: &HtmlTableCellElement, value: u32);
    # [ wasm_bindgen ( structural , method , getter , js_name = rowSpan ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = rowSpan ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = headers ) ]
    #[doc = "Setter for the `headers` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableCellElement/headers)\n\n*This API requires the following crate features to be activated: `HtmlTableCellElement`*"]
    pub fn set_headers(this: &HtmlTableCellElement, value: String);
    # [ wasm_bindgen ( structural , method , getter , js_name = cellIndex ) ]
    ...
    pub fn set_align(this: &HtmlTableCellElement, value: String);
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = axis ) ]
    #[doc = "Setter for the `axis` field of this object.\n\n[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableCellElement/axis)\n\n*This API requires the following crate features to be activated: `HtmlTableCellElement`*"]
    pub fn set_axis(this: &HtmlTableCellElement, value: String);
    ...
    pub fn set_height(this: &HtmlTableCellElement, value: String);
    ...
    pub fn set_width(this: &HtmlTableCellElement, value: String);
    ...
    pub fn set_ch(this: &HtmlTableCellElement, value: String);
    ...
    pub fn set_ch_off(this: &HtmlTableCellElement, value: String);
    # [ wasm_bindgen ( structural , method , getter , js_name = noWrap ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = noWrap ) ]
    ...
    pub fn set_v_align(this: &HtmlTableCellElement, value: String);
    ...
    pub fn set_bg_color(this: &HtmlTableCellElement, value: String);
}
