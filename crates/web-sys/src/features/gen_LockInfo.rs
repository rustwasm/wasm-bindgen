...
extern "C" {
    ...
    pub fn get_client_id(this: &LockInfo) -> Option<String>;
    #[wasm_bindgen(method, setter = "clientId")]
    fn set_client_id(this: &LockInfo, val: &str);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_mode(this: &LockInfo, val: LockMode);
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_name(this: &LockInfo) -> Option<String>;
    #[wasm_bindgen(method, setter = "name")]
    fn set_name(this: &LockInfo, val: &str);
}
#[cfg(web_sys_unstable_apis)]
impl LockInfo {
