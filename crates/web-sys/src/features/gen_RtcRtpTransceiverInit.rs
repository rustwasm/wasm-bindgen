...
extern "C" {
    ...
    fn set_direction(this: &RtcRtpTransceiverInit, val: RtcRtpTransceiverDirection);
    ...
    fn set_send_encodings(this: &RtcRtpTransceiverInit, val: &::wasm_bindgen::JsValue);
    ...
    fn set_streams(this: &RtcRtpTransceiverInit, val: &::wasm_bindgen::JsValue);
}
