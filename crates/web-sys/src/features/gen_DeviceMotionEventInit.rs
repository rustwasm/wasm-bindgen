...
impl DeviceMotionEventInit {
    ///Construct a new `DeviceMotionEventInit`.
    ///
    ///*This API requires the following crate features to be activated: `DeviceMotionEventInit`*
    ...
    ///Change the `acceleration` field of this object.
    ///
    ...
    #[cfg(feature = "DeviceAccelerationInit")]
    ///Change the `accelerationIncludingGravity` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `DeviceAccelerationInit`, `DeviceMotionEventInit`*
    ...
    ///Change the `interval` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `DeviceMotionEventInit`*
    ...
    ///Change the `rotationRate` field of this object.
    ///
