...
extern "C" {
    ...
    fn set_bubbles(this: &XrInputSourcesChangeEventInit, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_cancelable(this: &XrInputSourcesChangeEventInit, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_composed(this: &XrInputSourcesChangeEventInit, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_added(this: &XrInputSourcesChangeEventInit, val: &::wasm_bindgen::JsValue);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_removed(this: &XrInputSourcesChangeEventInit, val: &::wasm_bindgen::JsValue);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_session(this: &XrInputSourcesChangeEventInit, val: &XrSession);
}
#[cfg(web_sys_unstable_apis)]
