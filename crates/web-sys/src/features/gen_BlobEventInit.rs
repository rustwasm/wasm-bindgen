...
extern "C" {
    ...
    fn set_bubbles(this: &BlobEventInit, val: bool);
    ...
    fn set_cancelable(this: &BlobEventInit, val: bool);
    ...
    fn set_composed(this: &BlobEventInit, val: bool);
    #[cfg(feature = "Blob")]
    ...
    fn set_data(this: &BlobEventInit, val: Option<&Blob>);
}
impl BlobEventInit {
