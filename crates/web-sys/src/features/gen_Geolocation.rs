...
extern "C" {
    ...
    # [ wasm_bindgen ( method , structural , js_name = clearWatch ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getCurrentPosition ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = watchPosition ) ]
