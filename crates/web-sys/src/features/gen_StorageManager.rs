...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `StorageManager`*"]
    #[doc = ""]
    #[doc = "Return value: While the Promise can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>[StorageEstimate]</code>. It can be converted like `<code>let result: [StorageEstimate] = result?.await.into();</code>."]
