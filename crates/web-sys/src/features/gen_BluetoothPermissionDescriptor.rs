...
extern "C" {
    ...
    fn set_name(this: &BluetoothPermissionDescriptor, val: PermissionName);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_accept_all_devices(this: &BluetoothPermissionDescriptor, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_device_id(this: &BluetoothPermissionDescriptor, val: &str);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_filters(this: &BluetoothPermissionDescriptor, val: &::wasm_bindgen::JsValue);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_optional_services(this: &BluetoothPermissionDescriptor, val: &::wasm_bindgen::JsValue);
}
#[cfg(web_sys_unstable_apis)]
