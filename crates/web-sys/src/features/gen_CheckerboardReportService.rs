...
extern "C" {
    ...
    # [ wasm_bindgen ( method , structural , js_name = flushActiveReports ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getReports ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = isRecordingEnabled ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setRecordingEnabled ) ]
