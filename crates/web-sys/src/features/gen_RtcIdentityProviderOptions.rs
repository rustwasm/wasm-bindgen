...
extern "C" {
    ...
    fn set_peer_identity(this: &RtcIdentityProviderOptions, val: &str);
    ...
    fn set_protocol(this: &RtcIdentityProviderOptions, val: &str);
    ...
    fn set_username_hint(this: &RtcIdentityProviderOptions, val: &str);
}
