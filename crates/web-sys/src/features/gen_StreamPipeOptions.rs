...
extern "C" {
    ...
    fn set_prevent_abort(this: &StreamPipeOptions, val: bool);
    ...
    fn set_prevent_cancel(this: &StreamPipeOptions, val: bool);
    ...
    fn set_prevent_close(this: &StreamPipeOptions, val: bool);
    ...
    fn set_signal(this: &StreamPipeOptions, val: &AbortSignal);
}
