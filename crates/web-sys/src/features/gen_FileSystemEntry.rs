...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = isFile ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = isDirectory ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = fullPath ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = filesystem ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getParent ) ]
