...
extern "C" {
    ...
    ///The `GpuBindGroupLayoutBinding` dictionary.
    ///
    ///*This API requires the following crate features to be activated: `GpuBindGroupLayoutBinding`*
    ///
...
impl GpuBindGroupLayoutBinding {
    ...
    ///Construct a new `GpuBindGroupLayoutBinding`.
    ///
    ///*This API requires the following crate features to be activated: `GpuBindGroupLayoutBinding`, `GpuBindingType`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ///[described in the `wasm-bindgen` guide](https://rustwasm.github.io/docs/wasm-bindgen/web-sys/unstable-apis.html)*
    ...
    #[cfg(web_sys_unstable_apis)]
    ///Change the `binding` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `GpuBindGroupLayoutBinding`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ...
    ///Change the `textureComponentType` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `GpuBindGroupLayoutBinding`, `GpuTextureComponentType`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ///[described in the `wasm-bindgen` guide](https://rustwasm.github.io/docs/wasm-bindgen/web-sys/unstable-apis.html)*
    ...
    ///Change the `textureDimension` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `GpuBindGroupLayoutBinding`, `GpuTextureViewDimension`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ///[described in the `wasm-bindgen` guide](https://rustwasm.github.io/docs/wasm-bindgen/web-sys/unstable-apis.html)*
    ...
    #[cfg(web_sys_unstable_apis)]
    ///Change the `visibility` field of this object.
    ///
    ///*This API requires the following crate features to be activated: `GpuBindGroupLayoutBinding`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
