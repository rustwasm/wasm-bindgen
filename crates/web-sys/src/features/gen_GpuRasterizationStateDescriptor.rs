...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `GpuRasterizationStateDescriptor`*"]
...
impl GpuRasterizationStateDescriptor {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `GpuCullMode`, `GpuRasterizationStateDescriptor`*"]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `GpuFrontFace`, `GpuRasterizationStateDescriptor`*"]
