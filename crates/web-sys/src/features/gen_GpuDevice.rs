...
extern "C" {
    ...
    #[wasm_bindgen(
        ...
        structural,
        js_class = "GPUDevice",
        js_name = "createComputePipelineAsync"
    )]
    ...
    #[wasm_bindgen(
        ...
        structural,
        js_class = "GPUDevice",
        js_name = "createRenderPipelineAsync"
    )]
