...
extern "C" {
    ...
    fn set_depth_bias(this: &GpuDepthStencilState, val: i32);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_bias_clamp(this: &GpuDepthStencilState, val: f32);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_bias_slope_scale(this: &GpuDepthStencilState, val: f32);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_compare(this: &GpuDepthStencilState, val: GpuCompareFunction);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_write_enabled(this: &GpuDepthStencilState, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_format(this: &GpuDepthStencilState, val: GpuTextureFormat);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_stencil_back(this: &GpuDepthStencilState, val: &GpuStencilFaceState);
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuStencilFaceState")]
    ...
    fn set_stencil_front(this: &GpuDepthStencilState, val: &GpuStencilFaceState);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_stencil_read_mask(this: &GpuDepthStencilState, val: u32);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_stencil_write_mask(this: &GpuDepthStencilState, val: u32);
}
#[cfg(web_sys_unstable_apis)]
