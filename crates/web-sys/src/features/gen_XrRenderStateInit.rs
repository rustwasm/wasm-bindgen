...
extern "C" {
    ...
    fn set_base_layer(this: &XrRenderStateInit, val: Option<&XrWebGlLayer>);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_far(this: &XrRenderStateInit, val: f64);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_depth_near(this: &XrRenderStateInit, val: f64);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_inline_vertical_field_of_view(this: &XrRenderStateInit, val: f64);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_layers(this: &XrRenderStateInit, val: &::wasm_bindgen::JsValue);
}
#[cfg(web_sys_unstable_apis)]
