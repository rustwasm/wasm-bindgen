...
extern "C" {
    ...
    pub fn get_id(this: &DirectoryPickerOptions) -> Option<String>;
    #[wasm_bindgen(method, setter = "id")]
    fn set_id(this: &DirectoryPickerOptions, val: &str);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_mode(this: &DirectoryPickerOptions, val: FileSystemPermissionMode);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_start_in(this: &DirectoryPickerOptions, val: &::wasm_bindgen::JsValue);
}
#[cfg(web_sys_unstable_apis)]
