...
extern "C" {
    ...
    # [ wasm_bindgen ( method , structural , js_name = getAudioTracks ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getTracks ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getVideoTracks ) ]
