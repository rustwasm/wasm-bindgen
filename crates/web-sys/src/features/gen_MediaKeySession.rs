...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = sessionId ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = expiration ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = closed ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = keyStatuses ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = onkeystatuseschange ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = generateRequest ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = update ) ]
