...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `CredentialsContainer`*"]
    #[doc = ""]
    #[doc = "Return value: While the Promise of the successful result can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>[Option]<[Credential]></code>. It can be converted like `<code>let result: [Option]<[Credential]> = result?.await.into();</code>."]
    ...
    #[doc = ""]
    #[doc = "Return value: While the Promise of the successful result can produce any JsValue as far as the type system is concerned, practically it is expected to contain a <code>[Credential]</code>. It can be converted like `<code>let result: [Credential] = result?.await.into();</code>."]
    pub fn store(
        this: &CredentialsContainer,
