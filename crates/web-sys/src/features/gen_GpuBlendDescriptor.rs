...
extern "C" {
    ...
    ///The `GpuBlendDescriptor` dictionary.
    ///
    ///*This API requires the following crate features to be activated: `GpuBlendDescriptor`*
    ///
...
impl GpuBlendDescriptor {
    ///Construct a new `GpuBlendDescriptor`.
    ///
    ///*This API requires the following crate features to be activated: `GpuBlendDescriptor`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ...
    ///
    ///*This API requires the following crate features to be activated: `GpuBlendDescriptor`, `GpuBlendFactor`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ///[described in the `wasm-bindgen` guide](https://rustwasm.github.io/docs/wasm-bindgen/web-sys/unstable-apis.html)*
    ...
    ///
    ///*This API requires the following crate features to be activated: `GpuBlendDescriptor`, `GpuBlendOperation`*
    ///
    ///*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as
    ///[described in the `wasm-bindgen` guide](https://rustwasm.github.io/docs/wasm-bindgen/web-sys/unstable-apis.html)*
