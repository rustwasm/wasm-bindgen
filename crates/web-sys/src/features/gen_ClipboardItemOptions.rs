...
extern "C" {
    ...
    fn presentation_style_shim(this: &ClipboardItemOptions) -> PresentationStyle;
    #[cfg(feature = "PresentationStyle")]
    #[wasm_bindgen(method, setter = "presentationStyle")]
    fn set_presentation_style_shim(this: &ClipboardItemOptions, val: PresentationStyle);
}
#[cfg(web_sys_unstable_apis)]
...
impl ClipboardItemOptions {
    ...
    pub fn presentation_style(&mut self, val: PresentationStyle) -> &mut Self {
        self.set_presentation_style_shim(val);
        self
    }
}
#[cfg(web_sys_unstable_apis)]
