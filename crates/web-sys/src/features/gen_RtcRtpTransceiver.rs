...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = mid ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = sender ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = stopped ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = direction ) ]
    #[cfg(feature = "RtcRtpTransceiverDirection")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = currentDirection ) ]
    #[cfg(feature = "RtcRtpTransceiverDirection")]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getRemoteTrackId ) ]
