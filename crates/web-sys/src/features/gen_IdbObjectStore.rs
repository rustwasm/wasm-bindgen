...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = indexNames ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = autoIncrement ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = createIndex ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = deleteIndex ) ]
    ...
    #[cfg(feature = "IdbIndex")]
    # [ wasm_bindgen ( catch , method , structural , js_name = index ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , structural , js_name = put ) ]
