...
extern "C" {
    ...
    pub type FetchEvent;
    # [ wasm_bindgen ( structural , method , getter , js_name = request ) ]
    #[cfg(feature = "Request")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = clientId ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = isReload ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = respondWith ) ]
