...
extern "C" {
    ...
    fn set_channel_count(this: &ChannelMergerOptions, val: u32);
    ...
    fn set_channel_count_mode(this: &ChannelMergerOptions, val: ChannelCountMode);
    ...
    fn set_channel_interpretation(this: &ChannelMergerOptions, val: ChannelInterpretation);
    ...
    fn set_number_of_inputs(this: &ChannelMergerOptions, val: u32);
}
