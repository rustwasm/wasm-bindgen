...
#[wasm_bindgen]
extern "C" {
    # [ wasm_bindgen ( extends = :: js_sys :: Object , js_name = SVGLength , typescript_name = SVGLength ) ]
    ...
    pub type SvgLength;
    # [ wasm_bindgen ( structural , method , getter , js_name = unitType ) ]
    ...
    # [ wasm_bindgen ( structural , method , setter , js_name = valueInSpecifiedUnits ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = valueAsString ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = newValueSpecifiedUnits ) ]
