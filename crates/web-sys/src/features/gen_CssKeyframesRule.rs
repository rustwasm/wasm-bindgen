...
extern "C" {
    ...
    pub fn set_name(this: &CssKeyframesRule, value: String);
    ...
    # [ wasm_bindgen ( method , structural , js_name = appendRule ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = deleteRule ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = findRule ) ]
