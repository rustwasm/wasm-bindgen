...
extern "C" {
    ...
    ///Getter for the `resultIndex` field of this object.
    ///
    ...
    ///Getter for the `results` field of this object.
    ///
    ...
    ///Getter for the `interpretation` field of this object.
    ///
    ...
    ///Getter for the `emma` field of this object.
    ///
    ...
    ///The `new SpeechRecognitionEvent(..)` constructor, creating a new instance of `SpeechRecognitionEvent`.
    ///
