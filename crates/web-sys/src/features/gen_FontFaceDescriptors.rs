...
extern "C" {
    ...
    fn display_shim(this: &FontFaceDescriptors) -> &str;
    ...
    fn feature_settings_shim(this: &FontFaceDescriptors) -> &str;
    ...
    fn unicode_range_shim(this: &FontFaceDescriptors) -> &str;
    ...
    fn variant_shim(this: &FontFaceDescriptors) -> &str;
    ...
    fn variation_settings_shim(this: &FontFaceDescriptors) -> &str;
    ...
    fn weight_shim(this: &FontFaceDescriptors) -> &str;
