...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = createSession ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = getStatusForPolicy ) ]
    ...
    # [ wasm_bindgen ( method , structural , js_name = setServerCertificate ) ]
