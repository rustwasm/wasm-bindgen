...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = patternUnits ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = patternContentUnits ) ]
    #[cfg(feature = "SvgAnimatedEnumeration")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = patternTransform ) ]
