...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = dropEffect ) ]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = types ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = clearData ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getData ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getFiles ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = getFilesAndDirectories ) ]
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = setData ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , structural , js_name = setDragImage ) ]
