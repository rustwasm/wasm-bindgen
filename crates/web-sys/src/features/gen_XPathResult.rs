...
extern "C" {
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = resultType ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = numberValue ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = stringValue ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = booleanValue ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = singleNodeValue ) ]
    #[cfg(feature = "Node")]
    ...
    # [ wasm_bindgen ( structural , method , getter , js_name = invalidIteratorState ) ]
    ...
    # [ wasm_bindgen ( structural , catch , method , getter , js_name = snapshotLength ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , structural , js_name = iterateNext ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , structural , js_name = snapshotItem ) ]
