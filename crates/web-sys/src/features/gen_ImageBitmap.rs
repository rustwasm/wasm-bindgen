...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , structural , js_name = findOptimalFormat ) ]
    ...
    #[cfg(feature = "ImageBitmapFormat")]
    # [ wasm_bindgen ( catch , method , structural , js_name = mapDataInto ) ]
    ...
    #[cfg(feature = "ImageBitmapFormat")]
    # [ wasm_bindgen ( catch , method , structural , js_name = mappedDataLength ) ]
