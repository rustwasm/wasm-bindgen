...
extern "C" {
    ...
    fn set_multisampled(this: &GpuTextureBindingLayout, val: bool);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_sample_type(this: &GpuTextureBindingLayout, val: GpuTextureSampleType);
    #[cfg(web_sys_unstable_apis)]
    ...
    fn set_view_dimension(this: &GpuTextureBindingLayout, val: GpuTextureViewDimension);
}
#[cfg(web_sys_unstable_apis)]
