...
extern "C" {
    ...
    fn set_auto_gain_control(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_browser_window(this: &MediaTrackConstraints, val: f64);
    ...
    fn set_channel_count(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_device_id(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_echo_cancellation(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_facing_mode(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_frame_rate(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_height(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_media_source(this: &MediaTrackConstraints, val: &str);
    ...
    fn set_noise_suppression(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_scroll_with_page(this: &MediaTrackConstraints, val: bool);
    ...
    fn set_viewport_height(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_viewport_offset_x(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_viewport_offset_y(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_viewport_width(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_width(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
    ...
    fn set_advanced(this: &MediaTrackConstraints, val: &::wasm_bindgen::JsValue);
}
