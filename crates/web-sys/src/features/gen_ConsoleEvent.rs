...
extern "C" {
    ...
    fn console_id_shim(this: &ConsoleEvent) -> String;
    ...
    fn group_name_shim(this: &ConsoleEvent) -> String;
    ...
    fn level_shim(this: &ConsoleEvent) -> String;
    ...
    fn prefix_shim(this: &ConsoleEvent) -> String;
    ...
    fn styles_shim(this: &ConsoleEvent) -> ::js_sys::Array;
