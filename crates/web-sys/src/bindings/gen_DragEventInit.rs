...
#[allow(clippy::all)]
impl DragEventInit {
    #[doc = "Construct a new `DragEventInit`\n\n\n*This API requires the following crate features to be activated: `DataTransfer`, `DragEventInit`, `EventTarget`, `Window`*"]
    pub fn new() -> DragEventInit {
        let mut _ret = DragEventInit {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `dataTransfer` field of this object\n\n\n*This API requires the following crate features to be activated: `DataTransfer`, `DragEventInit`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_DragEventInit: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<DragEventInit> for JsValue {
        #[inline]
        fn from(val: DragEventInit) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for DragEventInit {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for DragEventInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for DragEventInit {
    ...
    impl FromWasmAbi for DragEventInit {
    ...
    impl OptionIntoWasmAbi for DragEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a DragEventInit {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for DragEventInit {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for DragEventInit {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<DragEventInit>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(DragEventInit {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for DragEventInit {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const DragEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_cc0d3de904bdeb07: [u8; 105usize] = {
