...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_RtcStats: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<RtcStats> for JsValue {
        #[inline]
        fn from(val: RtcStats) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for RtcStats {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for RtcStats {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for RtcStats {
    ...
    impl OptionIntoWasmAbi for RtcStats {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    ...
    impl OptionFromWasmAbi for RtcStats {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for RtcStats {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<RtcStats>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(RtcStats {
    ...
    impl JsCast for RtcStats {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const RtcStats) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_125d62d2444b3abc: [u8; 105usize] = {
