...
impl MediaTrackConstraints {
    ...
    pub fn new() -> MediaTrackConstraints {
        let mut _ret = MediaTrackConstraints {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `advanced` field of this object\n\n\n*This API requires the following crate features to be activated: `MediaTrackConstraints`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_MediaTrackConstraints: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<MediaTrackConstraints> for JsValue {
        #[inline]
        fn from(val: MediaTrackConstraints) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for MediaTrackConstraints {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for MediaTrackConstraints {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for MediaTrackConstraints {
    ...
    impl<'a> IntoWasmAbi for &'a MediaTrackConstraints {
    ...
    impl FromWasmAbi for MediaTrackConstraints {
    ...
    impl OptionIntoWasmAbi for MediaTrackConstraints {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a MediaTrackConstraints {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for MediaTrackConstraints {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for MediaTrackConstraints {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<MediaTrackConstraints>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(MediaTrackConstraints {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for MediaTrackConstraints {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const MediaTrackConstraints) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_b8154f7d97b54877: [u8; 105usize] = {
