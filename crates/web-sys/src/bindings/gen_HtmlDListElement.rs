...
#[allow(bad_style)]
#[allow(clippy::all)]
const __wbg_generated_const_HtmlDListElement: () = {
    ...
    impl WasmDescribe for HtmlDListElement {
        fn describe() {
    ...
    impl RefFromWasmAbi for HtmlDListElement {
        ...
        type Anchor = core::mem::ManuallyDrop<HtmlDListElement>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <JsValue as RefFromWasmAbi>::ref_from_abi(js);
            core::mem::ManuallyDrop::new(HtmlDListElement {
    ...
    impl AsRef<HtmlDListElement> for HtmlDListElement {
        #[inline]
        fn as_ref(&self) -> &HtmlDListElement {
            self
        }
    }
    ...
    impl JsCast for HtmlDListElement {
        fn instanceof(val: &JsValue) -> bool {
            ...
            extern "C" {
                fn __widl_instanceof_HTMLDListElement(val: u32) -> u32;
            }
            #[cfg(not(all(target_arch = "wasm32", not(target_os = "emscripten"))))]
            unsafe fn __widl_instanceof_HTMLDListElement(_: u32) -> u32 {
                panic!("cannot check instanceof on non-wasm targets");
            }
            unsafe {
                let idx = val.into_abi();
                __widl_instanceof_HTMLDListElement(idx) != 0
            }
        }
        #[inline]
        fn unchecked_from_js(val: JsValue) -> Self {
            HtmlDListElement { obj: val.into() }
        }
        #[inline]
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const HtmlDListElement) }
        }
    }
    ()
};
...
#[allow(clippy::all)]
impl From<HtmlDListElement> for ::js_sys::Object {
    #[inline]
    fn from(obj: HtmlDListElement) -> ::js_sys::Object {
        use wasm_bindgen::JsCast;
        ::js_sys::Object::unchecked_from_js(obj.into())
    }
}
#[allow(clippy::all)]
impl AsRef<::js_sys::Object> for HtmlDListElement {
    #[inline]
...
#[cfg(all(feature = "HtmlDListElement",))]
#[no_mangle]
#[allow(non_snake_case)]
#[doc(hidden)]
#[cfg(all(target_arch = "wasm32", not(target_os = "emscripten")))]
#[allow(clippy::all)]
pub extern "C" fn __wbindgen_describe___widl_f_compact_HTMLDListElement() {
    use wasm_bindgen::describe::*;
    wasm_bindgen::__rt::link_mem_intrinsics();
    inform(FUNCTION);
    inform(0);
    inform(1u32);
    <&HtmlDListElement as WasmDescribe>::describe();
...
impl HtmlDListElement {
    ...
    pub fn compact(&self) -> bool {
        ...
        #[cfg(all(target_arch = "wasm32", not(target_os = "emscripten")))]
        extern "C" {
            fn __widl_f_compact_HTMLDListElement(
                self_: <&HtmlDListElement as wasm_bindgen::convert::IntoWasmAbi>::Abi,
            ) -> <bool as wasm_bindgen::convert::FromWasmAbi>::Abi;
        }
        #[cfg(not(all(target_arch = "wasm32", not(target_os = "emscripten"))))]
        unsafe fn __widl_f_compact_HTMLDListElement(
            self_: <&HtmlDListElement as wasm_bindgen::convert::IntoWasmAbi>::Abi,
        ) -> <bool as wasm_bindgen::convert::FromWasmAbi>::Abi {
            drop(self_);
            panic!(
        ...
        unsafe {
            let _ret = {
                let self_ =
                    <&HtmlDListElement as wasm_bindgen::convert::IntoWasmAbi>::into_abi(self);
                __widl_f_compact_HTMLDListElement(self_)
            };
...
#[cfg(all(target_arch = "wasm32", not(target_os = "emscripten")))]
#[allow(clippy::all)]
pub extern "C" fn __wbindgen_describe___widl_f_set_compact_HTMLDListElement() {
    use wasm_bindgen::describe::*;
    wasm_bindgen::__rt::link_mem_intrinsics();
    inform(FUNCTION);
    inform(0);
...
impl HtmlDListElement {
    ...
    pub fn set_compact(&self, compact: bool) {
        ...
        #[cfg(all(target_arch = "wasm32", not(target_os = "emscripten")))]
        extern "C" {
            fn __widl_f_set_compact_HTMLDListElement(
                self_: <&HtmlDListElement as wasm_bindgen::convert::IntoWasmAbi>::Abi,
                compact: <bool as wasm_bindgen::convert::IntoWasmAbi>::Abi,
            ) -> ();
        }
        #[cfg(not(all(target_arch = "wasm32", not(target_os = "emscripten"))))]
        unsafe fn __widl_f_set_compact_HTMLDListElement(
            self_: <&HtmlDListElement as wasm_bindgen::convert::IntoWasmAbi>::Abi,
            compact: <bool as wasm_bindgen::convert::IntoWasmAbi>::Abi,
        ) -> () {
            drop(self_);
        ...
        unsafe {
            let _ret = {
                ...
                __widl_f_set_compact_HTMLDListElement(self_, compact)
            };
            ()
        }
    }
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_7f1792d113be2ba5: [u8; 343usize] = {
    static _INCLUDED_FILES: &[&str] = &[];
    * b":\0\0\0{\"schema_version\":\"0.2.58\",\"version\":\"0.2.58 (0f3c53b5a)\"}\x15\x01\0\0\0\0\x03\0\0\x02\x10HTMLDListElement\"__widl_instanceof_HTMLDListElement\0\0\0\0!__widl_f_compact_HTMLDListElement\0\0\0\x01\x10HTMLDListElement\x01\0\x01\x07compact\x01\x01\x05self_\x07compact\0\0\0%__widl_f_set_compact_HTMLDListElement\0\0\0\x01\x10HTMLDListElement\x01\0\x02\x07compact\x01\x02\x05self_\x07compact\x07compact\0\0\0\0\x1Ebuild-web-sys-3a70f0062dec68bf\0"
};
