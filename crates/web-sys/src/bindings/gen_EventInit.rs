...
const _CONST_EventInit: () = {
    ...
    impl WasmDescribe for EventInit {
        fn describe() {
            Object::describe();
        }
    }
    ...
    impl OptionFromWasmAbi for EventInit {
        #[inline]
    ...
    impl RefFromWasmAbi for EventInit {
        ...
        type Anchor = ManuallyDrop<EventInit>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(EventInit {
    ...
    impl JsCast for EventInit {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const EventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_376f10e38b44f94a: [u8; 105usize] = {
