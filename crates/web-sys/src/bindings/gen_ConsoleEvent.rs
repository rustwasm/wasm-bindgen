...
impl ConsoleEvent {
    ...
    pub fn new() -> ConsoleEvent {
        let mut _ret = ConsoleEvent {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `addonId` field of this object\n\n\n*This API requires the following crate features to be activated: `ConsoleEvent`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `groupName` field of this object\n\n\n*This API requires the following crate features to be activated: `ConsoleEvent`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `level` field of this object\n\n\n*This API requires the following crate features to be activated: `ConsoleEvent`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `private` field of this object\n\n\n*This API requires the following crate features to be activated: `ConsoleEvent`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `styles` field of this object\n\n\n*This API requires the following crate features to be activated: `ConsoleEvent`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `timer` field of this object\n\n\n*This API requires the following crate features to be activated: `ConsoleEvent`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_ConsoleEvent: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<ConsoleEvent> for JsValue {
        #[inline]
        fn from(val: ConsoleEvent) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for ConsoleEvent {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for ConsoleEvent {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for ConsoleEvent {
    ...
    impl FromWasmAbi for ConsoleEvent {
    ...
    impl OptionIntoWasmAbi for ConsoleEvent {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a ConsoleEvent {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for ConsoleEvent {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for ConsoleEvent {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<ConsoleEvent>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(ConsoleEvent {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for ConsoleEvent {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const ConsoleEvent) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_02751ff4a0aa7670: [u8; 105usize] = {
