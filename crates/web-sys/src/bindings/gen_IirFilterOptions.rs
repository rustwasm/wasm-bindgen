...
impl IirFilterOptions {
    #[doc = "Construct a new `IIRFilterOptions`\n\n\n*This API requires the following crate features to be activated: `ChannelCountMode`, `ChannelInterpretation`, `IirFilterOptions`*"]
    pub fn new(
        feedback: &::wasm_bindgen::JsValue,
        feedforward: &::wasm_bindgen::JsValue,
    ) -> IirFilterOptions {
        let mut _ret = IirFilterOptions {
            obj: ::js_sys::Object::new(),
        };
        _ret.feedback(feedback);
        _ret.feedforward(feedforward);
        return _ret;
    }
    #[allow(clippy::all)]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `feedback` field of this object\n\n\n*This API requires the following crate features to be activated: `IirFilterOptions`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `feedforward` field of this object\n\n\n*This API requires the following crate features to be activated: `IirFilterOptions`*"]
...
const _CONST_IirFilterOptions: () = {
    ...
    impl From<IirFilterOptions> for JsValue {
        #[inline]
        fn from(val: IirFilterOptions) -> JsValue {
            val.obj.into()
        }
    }
    ...
    impl WasmDescribe for IirFilterOptions {
        fn describe() {
            Object::describe();
        }
    }
    ...
    impl RefFromWasmAbi for IirFilterOptions {
        ...
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            ...
            ManuallyDrop::new(IirFilterOptions {
    ...
    impl JsCast for IirFilterOptions {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const IirFilterOptions) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_f36dee9a2e523740: [u8; 105usize] = {
