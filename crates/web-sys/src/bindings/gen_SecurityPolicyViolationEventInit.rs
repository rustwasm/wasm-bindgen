...
impl SecurityPolicyViolationEventInit {
    ...
    pub fn new() -> SecurityPolicyViolationEventInit {
        let mut _ret = SecurityPolicyViolationEventInit {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `blockedURI` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[cfg(all(feature = "SecurityPolicyViolationEventDisposition",))]
    #[allow(clippy::all)]
    #[doc = "Configure the `disposition` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventDisposition`, `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `documentURI` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `effectiveDirective` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `originalPolicy` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `sample` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `sourceFile` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `statusCode` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `violatedDirective` field of this object\n\n\n*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_SecurityPolicyViolationEventInit: () = {
    use js_sys::Object;
    ...
    impl From<SecurityPolicyViolationEventInit> for JsValue {
        #[inline]
        fn from(val: SecurityPolicyViolationEventInit) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for SecurityPolicyViolationEventInit {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for SecurityPolicyViolationEventInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for SecurityPolicyViolationEventInit {
    ...
    impl FromWasmAbi for SecurityPolicyViolationEventInit {
    ...
    impl OptionIntoWasmAbi for SecurityPolicyViolationEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    ...
    impl OptionFromWasmAbi for SecurityPolicyViolationEventInit {
        #[inline]
    ...
    impl RefFromWasmAbi for SecurityPolicyViolationEventInit {
        ...
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            ...
            ManuallyDrop::new(SecurityPolicyViolationEventInit {
    ...
    impl JsCast for SecurityPolicyViolationEventInit {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const SecurityPolicyViolationEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_3520cbc7212df1f6: [u8; 105usize] = {
