...
impl KeyboardEventInit {
    ...
    pub fn new() -> KeyboardEventInit {
        let mut _ret = KeyboardEventInit {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `charCode` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `code` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `isComposing` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `keyCode` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `location` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `repeat` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `which` field of this object\n\n\n*This API requires the following crate features to be activated: `KeyboardEventInit`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_KeyboardEventInit: () = {
    use js_sys::Object;
    ...
    impl From<KeyboardEventInit> for JsValue {
        #[inline]
        fn from(val: KeyboardEventInit) -> JsValue {
            val.obj.into()
        }
    }
    ...
    impl WasmDescribe for KeyboardEventInit {
        fn describe() {
            Object::describe();
        }
    }
    ...
    impl OptionIntoWasmAbi for KeyboardEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    ...
    impl OptionFromWasmAbi for KeyboardEventInit {
        #[inline]
    ...
    impl RefFromWasmAbi for KeyboardEventInit {
        ...
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            ...
            ManuallyDrop::new(KeyboardEventInit {
    ...
    impl JsCast for KeyboardEventInit {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const KeyboardEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_949490070d02942f: [u8; 105usize] = {
