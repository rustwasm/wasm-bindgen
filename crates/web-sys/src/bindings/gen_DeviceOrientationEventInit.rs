...
impl DeviceOrientationEventInit {
    ...
    pub fn new() -> DeviceOrientationEventInit {
        let mut _ret = DeviceOrientationEventInit {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `absolute` field of this object\n\n\n*This API requires the following crate features to be activated: `DeviceOrientationEventInit`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_DeviceOrientationEventInit: () = {
    use js_sys::Object;
    ...
    impl From<DeviceOrientationEventInit> for JsValue {
        #[inline]
        fn from(val: DeviceOrientationEventInit) -> JsValue {
            val.obj.into()
        }
    }
    ...
    impl WasmDescribe for DeviceOrientationEventInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for DeviceOrientationEventInit {
    ...
    impl FromWasmAbi for DeviceOrientationEventInit {
    ...
    impl OptionIntoWasmAbi for DeviceOrientationEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    ...
    impl OptionFromWasmAbi for DeviceOrientationEventInit {
        #[inline]
    ...
    impl RefFromWasmAbi for DeviceOrientationEventInit {
        ...
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            ...
            ManuallyDrop::new(DeviceOrientationEventInit {
    ...
    impl JsCast for DeviceOrientationEventInit {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const DeviceOrientationEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_52a4e3f498dd9b27: [u8; 105usize] = {
