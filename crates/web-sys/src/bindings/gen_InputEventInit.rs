...
impl InputEventInit {
    ...
    pub fn new() -> InputEventInit {
        let mut _ret = InputEventInit {
...
const _CONST_InputEventInit: () = {
    ...
    impl From<InputEventInit> for JsValue {
        #[inline]
        fn from(val: InputEventInit) -> JsValue {
            val.obj.into()
        }
    }
    ...
    impl WasmDescribe for InputEventInit {
        fn describe() {
            Object::describe();
        }
    }
    ...
    impl RefFromWasmAbi for InputEventInit {
        ...
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            ...
            ManuallyDrop::new(InputEventInit {
    ...
    impl JsCast for InputEventInit {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const InputEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_2571051793181178: [u8; 105usize] = {
