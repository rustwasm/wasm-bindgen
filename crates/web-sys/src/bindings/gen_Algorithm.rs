...
const _CONST_Algorithm: () = {
    ...
    impl WasmDescribe for Algorithm {
        fn describe() {
            Object::describe();
        }
    }
    ...
    impl RefFromWasmAbi for Algorithm {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<Algorithm>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(Algorithm {
    ...
    impl JsCast for Algorithm {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const Algorithm) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_9eebbd2e3536b869: [u8; 105usize] = {
