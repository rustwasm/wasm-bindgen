...
impl FocusEventInit {
    ...
    pub fn new() -> FocusEventInit {
        let mut _ret = FocusEventInit {
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_FocusEventInit: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<FocusEventInit> for JsValue {
        #[inline]
        fn from(val: FocusEventInit) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for FocusEventInit {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for FocusEventInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for FocusEventInit {
    ...
    impl FromWasmAbi for FocusEventInit {
    ...
    impl OptionIntoWasmAbi for FocusEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a FocusEventInit {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for FocusEventInit {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for FocusEventInit {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<FocusEventInit>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(FocusEventInit {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for FocusEventInit {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const FocusEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_734d00a610192f97: [u8; 105usize] = {
