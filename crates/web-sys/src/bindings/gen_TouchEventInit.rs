...
#[repr(transparent)]
#[allow(clippy::all)]
#[doc = "The `TouchEventInit` dictionary\n\n\n*This API requires the following crate features to be activated: `TouchEventInit`*"]
pub struct TouchEventInit {
    obj: ::js_sys::Object,
}
#[allow(clippy::all)]
impl TouchEventInit {
    #[doc = "Construct a new `TouchEventInit`\n\n\n*This API requires the following crate features to be activated: `TouchEventInit`, `Window`*"]
    pub fn new() -> TouchEventInit {
        let mut _ret = TouchEventInit {
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `changedTouches` field of this object\n\n\n*This API requires the following crate features to be activated: `TouchEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `targetTouches` field of this object\n\n\n*This API requires the following crate features to be activated: `TouchEventInit`*"]
    ...
    #[allow(clippy::all)]
    #[doc = "Configure the `touches` field of this object\n\n\n*This API requires the following crate features to be activated: `TouchEventInit`*"]
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_TouchEventInit: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<TouchEventInit> for JsValue {
        #[inline]
        fn from(val: TouchEventInit) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for TouchEventInit {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for TouchEventInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for TouchEventInit {
    ...
    impl FromWasmAbi for TouchEventInit {
    ...
    impl OptionIntoWasmAbi for TouchEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a TouchEventInit {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for TouchEventInit {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for TouchEventInit {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<TouchEventInit>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(TouchEventInit {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for TouchEventInit {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const TouchEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_cf56905963fd03bc: [u8; 105usize] = {
