...
impl MidiConnectionEventInit {
    #[doc = "Construct a new `MIDIConnectionEventInit`\n\n\n*This API requires the following crate features to be activated: `MidiConnectionEventInit`, `MidiPort`*"]
    pub fn new() -> MidiConnectionEventInit {
        let mut _ret = MidiConnectionEventInit {
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_MidiConnectionEventInit: () = {
    use js_sys::Object;
    ...
    impl From<MidiConnectionEventInit> for JsValue {
        #[inline]
        fn from(val: MidiConnectionEventInit) -> JsValue {
            val.obj.into()
        }
    }
    ...
    impl WasmDescribe for MidiConnectionEventInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for MidiConnectionEventInit {
    ...
    impl FromWasmAbi for MidiConnectionEventInit {
    ...
    impl OptionIntoWasmAbi for MidiConnectionEventInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    ...
    impl OptionFromWasmAbi for MidiConnectionEventInit {
        #[inline]
    ...
    impl RefFromWasmAbi for MidiConnectionEventInit {
        ...
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            ...
            ManuallyDrop::new(MidiConnectionEventInit {
    ...
    impl JsCast for MidiConnectionEventInit {
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const MidiConnectionEventInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_1415f20238e9db5e: [u8; 105usize] = {
