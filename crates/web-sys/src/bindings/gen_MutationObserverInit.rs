...
impl MutationObserverInit {
    ...
    pub fn new() -> MutationObserverInit {
        let mut _ret = MutationObserverInit {
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_MutationObserverInit: () = {
    use js_sys::Object;
    ...
    impl From<MutationObserverInit> for JsValue {
        #[inline]
        fn from(val: MutationObserverInit) -> JsValue {
            val.obj.into()
        }
    }
    ...
    impl WasmDescribe for MutationObserverInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for MutationObserverInit {
    ...
    impl<'a> IntoWasmAbi for &'a MutationObserverInit {
    ...
    impl FromWasmAbi for MutationObserverInit {
    ...
    impl OptionIntoWasmAbi for MutationObserverInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a MutationObserverInit {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for MutationObserverInit {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for MutationObserverInit {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<MutationObserverInit>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(MutationObserverInit {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for MutationObserverInit {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const MutationObserverInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_48a7e7466a6b94f7: [u8; 105usize] = {
