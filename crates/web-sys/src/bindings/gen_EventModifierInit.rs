...
#[repr(transparent)]
#[allow(clippy::all)]
#[doc = "The `EventModifierInit` dictionary\n\n\n*This API requires the following crate features to be activated: `EventModifierInit`*"]
pub struct EventModifierInit {
    obj: ::js_sys::Object,
}
#[allow(clippy::all)]
impl EventModifierInit {
    #[doc = "Construct a new `EventModifierInit`\n\n\n*This API requires the following crate features to be activated: `EventModifierInit`, `Window`*"]
    pub fn new() -> EventModifierInit {
        let mut _ret = EventModifierInit {
...
#[allow(bad_style)]
#[allow(clippy::all)]
const _CONST_EventModifierInit: () = {
    use js_sys::Object;
    use wasm_bindgen::__rt::core::mem::ManuallyDrop;
    use wasm_bindgen::convert::*;
    use wasm_bindgen::describe::WasmDescribe;
    use wasm_bindgen::{JsCast, JsValue};
    impl From<EventModifierInit> for JsValue {
        #[inline]
        fn from(val: EventModifierInit) -> JsValue {
            val.obj.into()
        }
    }
    impl AsRef<JsValue> for EventModifierInit {
        #[inline]
        fn as_ref(&self) -> &JsValue {
            self.obj.as_ref()
        }
    }
    impl WasmDescribe for EventModifierInit {
        fn describe() {
            Object::describe();
        }
    }
    impl IntoWasmAbi for EventModifierInit {
    ...
    impl<'a> IntoWasmAbi for &'a EventModifierInit {
    ...
    impl FromWasmAbi for EventModifierInit {
    ...
    impl OptionIntoWasmAbi for EventModifierInit {
        #[inline]
        fn none() -> Self::Abi {
            Object::none()
        }
    }
    impl<'a> OptionIntoWasmAbi for &'a EventModifierInit {
        #[inline]
        fn none() -> Self::Abi {
            <&'a Object>::none()
        }
    }
    impl OptionFromWasmAbi for EventModifierInit {
        #[inline]
        fn is_none(abi: &Self::Abi) -> bool {
            Object::is_none(abi)
        }
    }
    impl RefFromWasmAbi for EventModifierInit {
        type Abi = <Object as RefFromWasmAbi>::Abi;
        type Anchor = ManuallyDrop<EventModifierInit>;
        #[inline]
        unsafe fn ref_from_abi(js: Self::Abi) -> Self::Anchor {
            let tmp = <Object as RefFromWasmAbi>::ref_from_abi(js);
            ManuallyDrop::new(EventModifierInit {
                obj: ManuallyDrop::into_inner(tmp),
            })
        }
    }
    impl JsCast for EventModifierInit {
        #[inline]
        ...
        fn unchecked_from_js_ref(val: &JsValue) -> &Self {
            unsafe { &*(val as *const JsValue as *const EventModifierInit) }
        }
    }
};
...
#[doc(hidden)]
#[allow(clippy::all)]
pub static __WASM_BINDGEN_GENERATED_6901745bb97e1a87: [u8; 105usize] = {
